...
5. In IntelliJ IDEA, in the upper right corner choose: Add configuration

6. Press on the plus sign and add: Tomcat Server -> Local

7. Fix the artifact deployment by pressing on the "Fix" button that is marked with a red circle and an exclamation mark. If this is not done, no web application will be deployed to Tomcat.

8. The project is now setup.
